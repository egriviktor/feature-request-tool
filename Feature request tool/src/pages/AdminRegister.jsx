...
const AdminRegister = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Simulate delay
    setTimeout(() => {
      const result = registerDirect(name, email, password, 'admin');
      if (result.success) {
        navigate('/');
      } else {
          ...
          <Box component="form" onSubmit={handleSubmit}>
            <TextField
              ...
              InputProps={{
                ...
                sx: { borderRadius: 3, backgroundColor: 'rgba(255, 255, 255, 0.03)' }
              }}
            />
            <TextField
              fullWidth
            ...
            >
              {loading ? 'Creating Identity...' : 'Initialize Admin Account'}
            </Button>
            ...
            <Box sx={{ mt: 5, display: 'flex', flexDirection: 'column', gap: 2 }}>
              ...
              <Box sx={{ pt: 2, borderTop: '1px solid rgba(255, 255, 255, 0.05)' }}>
                <MuiLink component={Link} to="/register" sx={{ color: 'text.disabled', fontSize: '0.8rem', textDecoration: 'none' }}>
